...
Duc Ngo – Roll-a-Ball Manual22222
HOW TO PLAY
...
5. (Special feature) The game is automatically over if a player falls off the
   stage.
   SPECIAL FEATURES
6. Players can pause the game with Backspace!
7. Rules from the original game tutorial was changed so that more scenarios
   could open up for game outcomes.
8. Players get dropped into the game, rather than standing idly from the
   start.
9. Split camera view for both players. Player 1 is viewed on the left and
   Player 2 is viewed on the right.
10. The canvas is scaled to match width or height! Feel free to play in whatever
